    ...
    <div className="app-shell">
      ...
      <main className="frame">
        <Routes>
          ...
          <Route path="/lobbies/:lobbyId" element={<RequireAuth token={auth.token} user={auth.user}><LobbyPage currentUserId={auth.user?.id ?? ''} currentUsername={auth.user?.username ?? ''} /></RequireAuth>} />
